      ...
      {[1, 2, 3, 4].map((n) => (
        <span
          ...
          style={{
            ...
            backgroundColor: n <= filled ? "#0D9488" : "#E5E7EB",
      ...
      {workExperiences.length > 0 && (
        <section style={{ marginBottom: 18 }}>
          ...
          {workExperiences.map((w, i) => (
            <div key={i} style={{ marginBottom: 12, paddingLeft: 12, borderLeft: `2px solid ${teal}` }}>
              ...
              <p style={{ fontSize: 11, color: teal, margin: "2px 0 0" }}>{w.company}</p>
              {w.points.length > 0 && (
