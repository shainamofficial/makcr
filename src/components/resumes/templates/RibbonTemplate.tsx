...
export default function RibbonTemplate({ user, summary, workExperiences, education, skills, projects, profilePictureUrl, includePhoto, sectionOrder }: ResumeData) {
  ...
  return (
    <div className="resume-page ribbon-template" style={{ fontFamily: "Inter, system-ui, sans-serif", width: "210mm", minHeight: "297mm", margin: "0 auto", background: "#FFFBF5", color: "#1a1a1a", padding: "15mm 20mm", wordSpacing: "0.05em" }}>
